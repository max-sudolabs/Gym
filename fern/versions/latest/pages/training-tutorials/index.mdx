...
<Card title="External Agent Harnesses" href="/training-tutorials/external-agent-harnesses">
Train on rollouts from a harness that runs outside Gym and returns no token ids, such as the Claude Code CLI.

<Badge minimal outlined>token capture</Badge> <Badge minimal outlined>blackbox agents</Badge>
</Card>
