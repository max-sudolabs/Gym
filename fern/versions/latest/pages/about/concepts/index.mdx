...
<Card title="Trajectories and observability" href="/about/concepts/trajectory-format">
Capture standardized rollout trajectories from model calls, agent observations, and resolution status.
</Card>
